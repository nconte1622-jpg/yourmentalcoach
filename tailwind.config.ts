  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        cue: {
          focus: "hsl(var(--cue-focus))",
          calm: "hsl(var(--cue-calm))",
        },
        "close-strong": {
          accent: "hsl(var(--close-strong-accent))",
        },
        sidebar: {
      ...
      animation: {
        "accordion-down": "accordion-down 0.4s cubic-bezier(0.32, 0.72, 0, 1)",
        "accordion-up": "accordion-up 0.4s cubic-bezier(0.32, 0.72, 0, 1)",
        "fade-in": "fade-in 0.4s cubic-bezier(0.32, 0.72, 0, 1)",
        "fade-in-slow": "fade-in-slow 0.6s cubic-bezier(0.32, 0.72, 0, 1)",
        "fade-in-gentle": "fade-in-gentle 0.5s cubic-bezier(0.32, 0.72, 0, 1)",
