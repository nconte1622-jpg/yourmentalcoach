  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        ...
        <span className="text-[8px] text-[#2d6a4f] opacity-50 ml-0.5">?</span>
      </button>
      ...
      {showInfo && (
        <>
          ...
          />
          {/* Tooltip panel */}
          <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 z-[80] w-[260px] rounded-2xl border border-[rgba(45,106,79,0.12)] bg-white p-4 shadow-[0_8px_24px_rgba(0,0,0,0.1)] backdrop-blur-xl animate-fade-in">
            <p className="text-[10px] uppercase tracking-[0.18em] text-[#2d6a4f] mb-2">What is Memory?</p>
            ...
            <button
              type="button"
              onClick={() => setShowInfo(false)}
              className="mt-3 w-full rounded-xl bg-white/6 py-2 text-xs text-[rgba(26,26,26,0.6)] hover:bg-white/10 transition-colors"
            >
              Got it
            </button>
          </div>
